...
export default function Finance({ basic_transactions = [], withdrawal_transactions = [] }) {
    return (
            ...
            <div className="bg-gray-200 rounded-2xl px-8 py-6">
                <Tabs.Root defaultValue="basic" className="w-full">
                    ...
                    <Tabs.Content value="basic" className="outline-hidden">
                        {basic_transactions.length > 0 ? (
                            <div className="space-y-6">
                                {basic_transactions.map((item, index) => (
                    ...
                    <Tabs.Content value="withdrawal" className="outline-hidden">
                        {withdrawal_transactions.length > 0 ? (
                            <div className="space-y-6">
                                {withdrawal_transactions.map((item, index) => (
                                    <div key={index} className="flex justify-between items-start">
                                        <div>
                                            <p className="text-sm font-medium">
                                                {item.title}
